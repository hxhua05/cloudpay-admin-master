import { login, logout, getInfo, getRsaKey } from '@/api/user'
    ...
    login ({ commit }, userInfo) {
        ...
        return new Promise((resolve, reject) => {
            login({ name: username.trim(), pass: password, number: number }).then(res => {
                ...
                let expiredate = new Date(curTime.setSeconds(curTime.getSeconds() + response.expires_in));
                commit('SET_TOKENEXPIRE', expiredate)
